...
export class Department extends Component{
    ...
    FilterFn(){
        ...
        var DepartementNameFilter = this.state.DepartementNameFilter;
    ...
    changeDepartementIdFilter = (e)=>{
        this.state.DepartementIdFilter=e.target.value;
        this.FilterFn();
    }
    changeDepartementNameFilter = (e)=>{
        this.state.DepartementNameFilter=e.target.value;
        this.FilterFn();
    }
...
<div>
    ...
    <tr>
        <th>
            ...
            onChange={this.changeDepartementIdFilter}
            placeholder="Filter"/>
            
            <button type="button" className="btn btn-light"
            onClick={()=>this.sortResult('DepartementId',true)}>
            ...
            <button type="button" className="btn btn-light"
            onClick={()=>this.sortResult('DepartementId',false)}>
        ...
        <div className="d-flex flex-row">
        <input className="form-control m-2"
            onChange={this.changeDepartementNameFilter}
            placeholder="Filter"/>

            <button type="button" className="btn btn-light"
            onClick={()=>this.sortResult('DepartementName',true)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-down-square-fill" viewBox="0 0 16 16">
                <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm6.5 4.5v5.793l2.146-2.147a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 1 1 .708-.708L7.5 10.293V4.5a.5.5 0 0 1 1 0z"/>
                </svg>
            </button>
            ...
            <button type="button" className="btn btn-light"
            onClick={()=>this.sortResult('DepartementName',false)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-up-square-fill" viewBox="0 0 16 16">
                <path d="M2 16a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2zm6.5-4.5V5.707l2.146 2.147a.5.5 0 0 0 .708-.708l-3-3a.5.5 0 0 0-.708 0l-3 3a.5.5 0 1 0 .708.708L7.5 5.707V11.5a.5.5 0 0 0 1 0z"/>
                </svg>
            </button>
    ...
    <tbody>
        {departments.map(dep=>
            <tr key={dep.DepartementId}>
                <td>{dep.DepartementId}</td>
                ...
                <button type="button"
                className="btn btn-light mr-1"
                onClick={()=>this.deleteClick(dep.DepartementId)}>
...
<div className="modal-content">
   ...
   <div className="modal-body">
       <div className="input-group mb-3">
        <span className="input-group-text">DepartementName</span>
        <input type="text" className="form-control"
        value={DepartementName}
        onChange={this.changeDepartementName}/>
       </div>
